...
(()=>{
    ...
    (()=>{
        ...
        const external_maptalks_namespaceObject = window.maptalks;
        const src_options = {
            tolerance: 15,
            filterGeometries: null
        };
        const TEMP_POINT = new external_maptalks_namespaceObject.Point(0, 0);
        ...
        const TEMP_POINT1 = new external_maptalks_namespaceObject.Point(0, 0), TEMP_POINT2 = new external_maptalks_namespaceObject.Point(0, 0), TEMP_POINT3 = new external_maptalks_namespaceObject.Point(0, 0), TEMP_POINT4 = new external_maptalks_namespaceObject.Point(0, 0), TEMP_EXTENT = new external_maptalks_namespaceObject.Extent(0, 0, 0, 0), TEMP_COORDINATE = new external_maptalks_namespaceObject.Coordinate(0, 0);
        ...
        class Snap extends external_maptalks_namespaceObject.Eventable(external_maptalks_namespaceObject.Class) {
            map;
            _mousePoint;
            _geometries;
            ...
            effectGeometry(geometry) {
                ...
                const snapTo = (handleConatainerPoint, lastContainerPoints)=>{
                    ...
                    if (filterGeometries && external_maptalks_namespaceObject.Util.isFunction(filterGeometries)) geometries = filterGeometries();
            ...
            _nearestGeometry(geometry, handleConatainerPoint, lastContainerPoints) {
                ...
                if (geometry instanceof external_maptalks_namespaceObject.Marker) {
                ...
                if (geometry instanceof external_maptalks_namespaceObject.LineString) {
                ...
                if (geometry instanceof external_maptalks_namespaceObject.Polygon) for(let i = 0, len = coordinates.length; i < len; i++){
